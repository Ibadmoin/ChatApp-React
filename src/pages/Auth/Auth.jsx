...
function Auth() {
  ...
  const onSignUp = async () => {
    ...
    try {
      await signInWithPhoneNumber(auth, formatPhone, appVerifier).then(
        (confirmationResult) => {
          ...
          <div className="Wrapper">
            ...
            {showOTP ? (
              <>
                ...
                <div className="OTPHeadingWrapper">
                ...
                <div className="WrongnumberWrapper">
                  <button onClick={handleSubmit} className="wrongNumber">
                    <span>Wrong Number, Correct it</span>
                  </button>
                </div>
              </>
            ) : (
